...
class Pos_GR extends StatefulWidget {
  const Pos_GR({super.key});

  @override
  State<Pos_GR> createState() => _Pos_GRState();
}

class _Pos_GRState extends State<Pos_GR> {
  ...
  getAdd_Product() async{
    ...
    return showDialog(context: context, builder: (context) {
      return  SingleChildScrollView(
        ...
        provx.global_get_list_product[i].kode, no_gr!, kodecab, 'GR', _temp_custid, _temp_custname,box.read('username'),_temp_nohp);
  ...
  Future<void> scanBarcodeNormal() async {
    ...
    await Provider.of<MultiDatas>(context, listen: false).Save_Tranpos(context,
        barcodeScanRes, no_gr!, kodecab, 'GR', _temp_custid, _temp_custname,box.read('username'),_temp_nohp);
    getTotal();
  }
  ...
  // IconButton(
            ...
            //     icon: Icon(Icons.sort_rounded)),
             ...
             IconButton(
                ...
                IconButton(
                onPressed: () {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => new Pos_GR(),));
                },
                icon: Icon(Icons.add)),
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                           // InAppWebViewExampleScreen(nopos: no_pos!,nohp: _temp_nohp,),
                            InAppWebViewExampleScreen(title:'GR Report',nopos: no_gr!,nohp: _temp_nohp,),
                      ));
