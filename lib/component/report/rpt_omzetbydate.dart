...
class InAppWebViewExampleScreen_omzetbydate extends StatefulWidget {
...
InAppWebViewExampleScreen_omzetbydate({Key?key,required this.date1,required this.date2,required this.kodecab,required this.nohp}):super(key: key);
...
//   }
  ...
  @override
  _InAppWebViewExampleScreen_omzetbydateState createState() =>
      new _InAppWebViewExampleScreen_omzetbydateState(date1:date1,date2:date2,kodecab:kodecab,nohp:nohp);
}

class _InAppWebViewExampleScreen_omzetbydateState extends State<InAppWebViewExampleScreen_omzetbydate> {
...
final String kodecab;
final String nohp;
  _InAppWebViewExampleScreen_omzetbydateState({required this.date1,required this.date2,required this.kodecab,required this.nohp});
...
// } 
  ...
  Widget build(BuildContext context) {
    ...
    Scaffold(
        ...
        appBar: AppBar(title: Text("Report Omzet By Date",style: TextStyle(fontSize: 13,)),
        ...
        body: Container(
          ...
          Expanded(
              child: InAppWebView(
      initialUrlRequest: URLRequest(url: Uri.parse(NamaServer.Server+'posheru/reportomzetbydate.php?date1='+date1+'&date2='+date2+'&kodecab='+kodecab+'&nohp='+nohp,)),
